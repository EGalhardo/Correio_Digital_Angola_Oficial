...
const STATIC_TRANSLATE_MAP: Record<string, Record<LanguageCode, string>> = {
  ...
  "Documentos Digitais": { pt: "Documentos Digitais", um: "Olovikanda Vyosola", ki: "Mikanda ya Thangu", kk: "Nsamu mia nzo", ch: "Chisinde chipema", ng: "Mikando ya kunda", kw: "Ombila yapongoka", nh: "Okanda kofuka", fi: "Mamboti mambote" },
