    ...
    <div className="pb-24 text-left animate-fadeIn space-y-6 w-full max-w-none mx-auto px-1 sm:px-2 font-sans">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white border border-slate-200 p-4.5 rounded-[20px] shadow-3xs text-left relative overflow-hidden">
          ...
          <span className="text-2xl md:text-3xl font-black text-[#0a2342] block mt-1 tracking-tight">{activeInstituions}/{institutions.length}</span>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-4.5 rounded-[20px] shadow-3xs cursor-pointer hover:border-indigo-300 transition-all text-left relative overflow-hidden" onClick={() => setIsManageKnowledgeOpen(true)}>
          ...
          <span className="text-2xl md:text-3xl font-black text-[#0a2342] block mt-1 tracking-tight">{aiStats.totalBases}</span>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-4.5 rounded-[20px] shadow-3xs text-left relative overflow-hidden">
          ...
          <span className="text-2xl md:text-3xl font-black text-[#0a2342] block mt-1 tracking-tight">{aiStats.totalConversations.toLocaleString('pt-AO')}</span>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-4.5 rounded-[20px] shadow-3xs text-left relative overflow-hidden">
          ...
          <span className="text-2xl md:text-3xl font-black text-emerald-700 block mt-1 tracking-tight">{aiStats.resolutionRate}%</span>
        </div>
      </div>
